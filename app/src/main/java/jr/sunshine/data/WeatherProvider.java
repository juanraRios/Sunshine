...
import static jr.sunshine.data.WeatherContract.*;
...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        result.addURI(authority, PATH_WEATHER,WEATHER);
        result.addURI(authority, PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        result.addURI(authority, PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);


        // 3) Return the new matcher!
        result.addURI(authority,WeatherContract.PATH_WEATHER,LOCATION);
        return result;
    }
